...
CREATE TABLE `post` (
  ...
  `title` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '帖子标题',
  ...
  `like_count` INT DEFAULT 0 COMMENT '点赞数(兼容字段，可选)',
  `comment_count` INT DEFAULT 0 COMMENT '评论数(兼容字段，可选)',
  `share_count` INT DEFAULT 0 COMMENT '分享数',
  `view_count` INT DEFAULT 0 COMMENT '浏览数(兼容字段，可选)',
